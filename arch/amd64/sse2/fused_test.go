...
func TestAddMulBlock_SSE2(t *testing.T) {
	sizes := []int{0, 1, 2, 3, 4, 5, 7, 8, 16, 32, 64, 100}
...
func TestMulAddBlock_SSE2(t *testing.T) {
	sizes := []int{0, 1, 2, 3, 4, 5, 7, 8, 16, 32, 64, 100}
...
func BenchmarkAddMulBlock_SSE2(b *testing.B) {

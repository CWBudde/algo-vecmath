...
// Uses SSE2 SIMD instructions to process 4 float32 values at once.
...
func RotateDecayComplexF32(re, im, cosW, sinW, decay []float32) {
	...
	rotateDecayComplexF32SSE2(re, im, cosW, sinW, decay)
}
...
func RotateDecayAccumulateF32(dst []float32, re, im, cosW, sinW, decay, gain []float32) {
	...
	rotateDecayAccumulateF32SSE2(dst, re, im, cosW, sinW, decay, gain)
}
